...
local Gui_to_return = {}
Gui_to_return.__index = Gui_to_return
local Actived_Functions = {}
local here = {}
function here.slider(parent: Instance, Position: UDim2, Size: UDim2, Callback)
...
function Starter()
local Animation = create("ScreenGui", {Name = "Animation"
IgnoreGuiInset = true
ResetOnSpawn = false
ZIndexBehavior = Enum.ZIndexBehavior.Sibling
Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")})
local Frame = create("Frame", {Name = "Frame"
...
Parent = Animation})
local Crown = create("ImageLabel", {Name = "Crown"
Position = UDim2.new(0.442857, 45, 5.157143, 0)
...
Rotation = -10
AnchorPoint = Vector2.new(0.5, 0.5)
Image = "rbxassetid://17409640887"
Parent = Frame})
local Text = create("TextLabel", {Name = "Text"
...
BorderColor3 = Color3.new(0, 0, 0)
TextTransparency = 0
Text = "Gui Created Speccialy For <font color='rgb(255, 0, 255)'>Viktor18834</font>"
...
RichText = true
Parent = Frame})
local link = create("TextBox", {Name = "link"
...
TextColor3 = Color3.new(0.415686, 0.443137, 1)
TextSize = 15
FontFace = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Bold, Enum.FontStyle.Italic)
TextXAlignment = Enum.TextXAlignment.Left
TextYAlignment = Enum.TextYAlignment.Top
RichText = true
Parent = Frame, TextEditable = false, ClearTextOnFocus = false})
return {
    Animation = Animation
Frame = Frame
Crown = Crown
...
local guiScript2 = create("Frame", {Name = "Frame", Position = UDim2.new(0.438389, 0, 0.524584, 0), Size = UDim2.new(0, 390, 0, 230), BackgroundColor3 = Color3.new(0.133333, 0.133333, 0.133333), BorderSizePixel = 0, AnchorPoint = Vector2.new(0, 0), Parent = guiScript1
Draggable=true,Active=true})
local guiScript3 = create("UICorner", {Name = "UICorner", CornerRadius = UDim.new(0, 10), Parent = guiScript2})
local guiScript4 = create("Frame", {Name = "Frame"
Size = UDim2.new(1, 0, 1, 0)
BackgroundColor3 = Color3.new(0.192157, 0.192157, 0.192157)
Parent = guiScript2})
local guiScript5 = create("UICorner", {Name = "UICorner"
CornerRadius = UDim.new(0, 10)
Parent = guiScript4})
local guiScript6 = create("Frame", {Name = "PagesSelect"
Position = UDim2.new(0, 0, 0.204, 0)
Size = UDim2.new(0, 105, 0, 183)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 1
Transparency = 1
Parent = guiScript4})
local guiScript7 = create("ScrollingFrame", {Name = "Scroll"
...
Parent = guiScript6})
local guiScript8 = create("UIListLayout", {Name = "UIListLayout"
Padding = UDim.new(0, 1)
HorizontalAlignment = Enum.HorizontalAlignment.Right
SortOrder = Enum.SortOrder.LayoutOrder
Parent = guiScript7})
local guiScript9 = create("Frame", {Name = "Line"
Position = UDim2.new(0, 5, 0, 0)
Size = UDim2.new(0, 5, 0, 27)
BackgroundColor3 = Color3.new(1, 1, 1)
BorderSizePixel = 0
BorderColor3 = Color3.new(0, 0, 0)
...
local guiScript11 = create("Frame", {Name = "MaxLine"
Position = UDim2.new(0, 5, 0, 0)
Size = UDim2.new(0, 5, 0, 27)
BackgroundColor3 = Color3.new(1, 1, 1)
...
local guiScript12 = create("UICorner", {CornerRadius = UDim.new(1, 0)
Parent = guiScript11})
local guiScript13 = create("CanvasGroup", {Name = "CanvasGroup"
Size = UDim2.new(1, 0, 1, 0)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 1
BorderSizePixel = 0
...
Transparency = 1
Parent = guiScript4})
local guiScript14 = create("ImageLabel", {Name = "Shadow"
Position = UDim2.new(0.5, 0, 0.5, 0)
...
AnchorPoint = Vector2.new(0.5, 0.5)
Transparency = 1
Image = "rbxassetid://7928096707"
ImageTransparency = 0.949999988079071
Parent = guiScript13})
local guiScript15 = create("TextLabel", {Name = "name"
...
LineHeight = 3
Parent = guiScript4})
local guiScript17 = create("ScrollingFrame", {Name = "Page"
Position = UDim2.new(1, 0, 1, 0)
Size = UDim2.new(1, -110, 0.8, -4)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 1
BorderSizePixel = 0
BorderColor3 = Color3.new(0, 0, 0)
...
Parent = guiScript4
AutomaticCanvasSize = Enum.AutomaticSize.Y})
local guiScript19 = create("Frame", {Name = "Lines"
Size = UDim2.new(1, 0, 1, 0)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 1
BorderSizePixel = 0
...
Transparency = 1
Parent = guiScript4})
local guiScript20 = create("Frame", {Name = "Line"
Position = UDim2.new(0, 106, 0.2, 0)
Size = UDim2.new(0, 2, 0.77, 0)
BackgroundColor3 = Color3.new(0.164706, 0.164706, 0.164706)
BackgroundTransparency = 1
BorderSizePixel = 0
BorderColor3 = Color3.new(0, 0, 0)
ZIndex = 5
Transparency = 1
Parent = guiScript19})
local guiScript21 = create("ImageLabel", {Name = "Shadow"
Position = UDim2.new(0.5, 0, 0.5, 0)
Size = UDim2.new(5, 0, 1.01, 0)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 1
BorderSizePixel = 0
BorderColor3 = Color3.new(0, 0, 0)
...
Transparency = 1
Image = "rbxassetid://7928096707"
ImageColor3 = Color3.new(0.172549, 0.172549, 0.172549)
Parent = guiScript20})
local guiScript22 = create("Frame", {Name = "Line"
...
Transparency = 1
Parent = guiScript19})
local guiScript23 = create("ImageLabel", {Name = "Shadow"
Position = UDim2.new(0.5, 0, 0.5, 0)
Size = UDim2.new(1.01, 0, 5, 0)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 1
BorderSizePixel = 0
BorderColor3 = Color3.new(0, 0, 0)
...
ImageColor3 = Color3.new(0.172549, 0.172549, 0.172549)
Parent = guiScript22})
local guiScript24 = create("ImageLabel", {Name = "Shadow"
Position = UDim2.new(0.5, 0, 0.5, 0)
...
Parent = guiScript1})
local guiScript25 = create("Frame", {Name = "Templates"
Size = UDim2.new(1, 0, 1, 0)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 1
BorderSizePixel = 0
...
Transparency = 1
Parent = guiScript1})
local guiScript26 = create("ImageLabel", {Name = "SelectImage"
Position = UDim2.new(0.5, 0, 0.5, 0)
...
Transparency = 1
Image = "rbxassetid://7928096707"
ImageColor3 = Color3.new(0.905882, 0.905882, 0.905882)
ImageTransparency = 0.800000011920929
Parent = guiScript25})
local guiScript27 = create("Frame", {Name = "Text"
Size = UDim2.new(1, 0, 0, 30)
BackgroundColor3 = Color3.new(0.219608, 0.219608, 0.219608)
BackgroundTransparency = 1
BorderSizePixel = 0
BorderColor3 = Color3.new(0, 0, 0)
Transparency = 1
Parent = guiScript25})
local guiScript28 = create("TextLabel", {Name = "Text"
...
TextTransparency = 0
Text = "SectionName"
TextColor3 = Color3.new(0.917647, 0.917647, 0.917647)
TextSize = 15
FontFace = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
TextWrapped = true
...
RichText = true
Parent = guiScript27})
local guiScript29 = create("TextButton", {Name = "ActivateButton"
Size = UDim2.new(1, 0, 1, 0)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 1
BorderSizePixel = 0
...
Parent = guiScript27})
local guiScript31 = create("TextButton", {Name = "TemplatePageSelect"
...
RichText = true
Parent = guiScript25})
local guiScript54 = create("TextButton", {Name = "Button"
Size = UDim2.new(1, 0, 0, 27)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 1
BorderSizePixel = 0
...
ZIndex = 15
Text = "PageName"
TextColor3 = Color3.new(0.952941, 0.952941, 0.952941)
TextSize = 19
TextTransparency = 0
FontFace = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
RichText = true
AutoButtonColor = false
Parent = guiScript31})
local guiScript56 = create("Frame", {Name = "MouseText"
Position = UDim2.new(0.49, 0, 0, 13)
...
Parent = guiScript31})
local guiScript57 = create("UICorner", {Name = "UICorner"
CornerRadius = UDim.new(0, 5)
Parent = guiScript56})
local guiScript58 = create("ImageLabel", {Name = "Shadow"
Position = UDim2.new(0.5, 0, 0.5, 0)
...
RichText = true
Parent = guiScript56})
local UIStroke3 = create("UIStroke", {Name = "UIStroke"
Thickness = 2
Parent = text})
local TextBox = create("Frame", {Name = "TextBox"
...
Transparency = 1
Parent = guiScript25})
local Text6 = create("TextLabel", {Name = "Text"
Position = UDim2.new(1, 0, 0, 0)
...
TextXAlignment = Enum.TextXAlignment.Left
Parent = TextBox})
local ActivateButton = create("TextButton", {Name = "ActivateButton"
Size = UDim2.new(1, 0, 1, 0)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 1
BorderSizePixel = 0
...
Parent = TextBox})
local UICorner7 = create("UICorner", {Name = "UICorner"
CornerRadius = UDim.new(1, 0)
Parent = hor})
local TextBox2 = create("Frame", {Name = "TextBox"
Position = UDim2.new(1, -15, 0.5, 0)
Size = UDim2.new(0, 150, 0.6, 0)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 1
BorderSizePixel = 0
BorderColor3 = Color3.new(0, 0, 0)
...
Transparency = 1
Parent = TextBox})
local TextBox3 = create("TextBox", {Name = "TextBox"
Size = UDim2.new(1, 0, 1, 0)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 1
BorderSizePixel = 0
...
RichText = true
Parent = TextBox2})
local UICorner8 = create("UICorner", {Name = "UICorner"
Parent = TextBox2})
local ImageLabel = create("ImageLabel", {Name = "ImageLabel"
Position = UDim2.new(0.5, 0, 0.5, 0)
Size = UDim2.new(1.3, 0, 1.5, 0)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 1
BorderSizePixel = 0
BorderColor3 = Color3.new(0, 0, 0)
...
Parent = TextBox2})
local Slide = create("Frame", {Name = "Slide"
...
Transparency = 1
Parent = guiScript25})
local UIStroke6 = create("UIStroke", {Name = "UIStroke"
Thickness = 2
Parent = guiScript28})
local ActivateButton2 = create("TextButton", {Name = "ActivateButton"
...
FontFace = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
AutoButtonColor = false
Parent = Slide, TextXAlignment = Enum.TextXAlignment.Left})
local _2 = create("Frame", {Name = "|"
Position = UDim2.new(0, 15, 0.5, 0)
Size = UDim2.new(0, 3, 0.8, 0)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 0.30000001192092896
...
Transparency = 0.30000001192092896
Parent = Slide})
local UICorner9 = create("UICorner", {Name = "UICorner"
CornerRadius = UDim.new(1, 0)
Parent = _2})
local Slide2 = create("Frame", {Name = "Slide"
Position = UDim2.new(1, -15, 0.5, 0)
Size = UDim2.new(0, 50, 0, 25)
BackgroundColor3 = Color3.new(0.223529, 0.223529, 0.223529)
BackgroundTransparency = 1
BorderSizePixel = 0
BorderColor3 = Color3.new(0, 0, 0)
AnchorPoint = Vector2.new(1, 0.5)
Transparency = 1
Parent = Slide})
local UICorner10 = create("UICorner", {Name = "UICorner"
CornerRadius = UDim.new(1, 0)
Parent = Slide2})
local UIStroke7 = create("UIStroke", {Name = "UIStroke"
Thickness = 3
...
Parent = Slide2})
local Dot = create("Frame", {Name = "Dot"
Size = UDim2.new(0, 25, 0, 25)
BackgroundColor3 = Color3.new(0.0823529, 0.0823529, 0.0823529)
BorderSizePixel = 0
BorderColor3 = Color3.new(0, 0, 0)
Parent = Slide2})
local UICorner11 = create("UICorner", {Name = "UICorner"
CornerRadius = UDim.new(1, 0)
Parent = Dot})
local ImageLabel3 = create("ImageLabel", {Name = "ImageLabel"
Size = UDim2.new(1, 0, 1, 0)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 1
BorderSizePixel = 0
...
Transparency = 1
Image = "rbxassetid://7928096707"
ImageTransparency = 0.9300000071525574
Parent = Dot})
local Keybind = create("Frame", {Name = "Keybind"
...
Transparency = 1
Parent = guiScript25})
local Text3 = create("TextLabel", {Name = "Text"
Position = UDim2.new(1, 0, 0, 0)
Size = UDim2.new(1, -30, 1, 0)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 1
...
TextXAlignment = Enum.TextXAlignment.Left
Parent = Keybind})
local ActivateButton3 = create("TextButton", {Name = "ActivateButton"
Size = UDim2.new(1, 0, 1, 0)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 1
BorderSizePixel = 0
...
Transparency = 0.30000001192092896
Parent = Keybind})
local UICorner12 = create("UICorner", {Name = "UICorner"
CornerRadius = UDim.new(1, 0)
Parent = _3})
local KeybindText = create("TextLabel", {Name = "KeybindText"
...
TextTransparency = 0
Text = "T"
TextColor3 = Color3.new(0.937255, 0.937255, 0.937255)
TextSize = 14
FontFace = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
TextScaled = true
TextWrapped = true
RichText = true
Parent = Keybind})
local ClickButton = create("Frame", {Name = "ClickButton"
...
Transparency = 1
Parent = guiScript25})
local Text4 = create("TextLabel", {Name = "Text"
Position = UDim2.new(1, 0, 0, 0)
Size = UDim2.new(1, -30, 1, 0)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 1
...
TextXAlignment = Enum.TextXAlignment.Left
Parent = ClickButton})
local ActivateButton4 = create("TextButton", {Name = "ActivateButton"
Size = UDim2.new(1, 0, 1, 0)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 1
BorderSizePixel = 0
...
Transparency = 0.30000001192092896
Parent = ClickButton})
local UICorner13 = create("UICorner", {Name = "UICorner"
CornerRadius = UDim.new(1, 0)
Parent = _4})
...
AnchorPoint = Vector2.new(1, 0.5)
Transparency = 1
Image = "rbxassetid://2418686949"
Parent = ClickButton})
local CanvasGroup2 = create("CanvasGroup", {Name = "CanvasGroup"
Position = UDim2.new(1, -9, 0.5, 0)
...
ImageTransparency = 0.699999988079071
Parent = CanvasGroup2})
local Section = create("Frame", {Name = "Section"
Size = UDim2.new(1, 0, 0, 30)
BackgroundColor3 = Color3.new(0.219608, 0.219608, 0.219608)
BackgroundTransparency = 1
BorderSizePixel = 0
...
Transparency = 1
Parent = guiScript25})
local Text5 = create("TextLabel", {Name = "Text"
Position = UDim2.new(1, 0, 0, 0)
Size = UDim2.new(1, -30, 1, 0)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 1
...
RichText = true
Parent = Section})
local ImageButton = create("ImageButton", {Name = "ImageButton"
Size = UDim2.new(0, 30, 0, 30)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 1
BorderSizePixel = 0
...
Parent = Section})
local More = create("Frame", {Name = "More"
Size = UDim2.new(1, 0, 1, 0)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 1
BorderSizePixel = 0
...
Transparency = 1
Parent = guiScript2})
local YScale:TextButton = create("TextButton", {Name = "YScale"
Position = UDim2.new(0.5, 0, 1, 5)
Size = UDim2.new(0, 150, 0, 9)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 0.5
BorderSizePixel = 0
BorderColor3 = Color3.new(0, 0, 0)
...
TextSize = 14
FontFace = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
Parent = More, AutoButtonColor = false})
local UICorner99 = create("UICorner", {Name = "UICorner"
CornerRadius = UDim.new(1, 0)
Parent = YScale})
local XScale = create("TextButton", {Name = "XScale"
Position = UDim2.new(1, 5, 0.5, 0)
Size = UDim2.new(0, 5, 0, 150)
BackgroundColor3 = Color3.new(1, 1, 1)
BackgroundTransparency = 0.5
BorderSizePixel = 0
BorderColor3 = Color3.new(0, 0, 0)
...
CornerRadius = UDim.new(1, 0)
Parent = XScale})
local Close = create("ImageButton", {Name = "Close"
...
AnchorPoint = Vector2.new(0.5, 0.5)
Transparency = 1
Image = "rbxassetid://90965270530088"
Parent = More})
local Settings = create("ImageButton", {Name = "Settings"
...
AnchorPoint = Vector2.new(0.5, 0.5)
Transparency = 1
Image = "rbxassetid://112630223329701"
Parent = More})
local Hide = create("ImageButton", {Name = "Hide"
...
ActivateButton.FontFace = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
ActivateButton.AutoButtonColor = false
ActivateButton.Parent = select
local _1 = Instance.new("Frame")
_1.Name = "|"
_1.Position = UDim2.new(0, 15, 0.5, 0)
_1.Size = UDim2.new(0, 3, 0.8, 0)
_1.BackgroundColor3 = Color3.new(1, 1, 1)
_1.BackgroundTransparency = 0.30000001192092896
_1.BorderSizePixel = 0
_1.BorderColor3 = Color3.new(0, 0, 0)
_1.AnchorPoint = Vector2.new(0.5, 0.5)
_1.Transparency = 0.30000001192092896
_1.Parent = select
local UICorner = Instance.new("UICorner")
UICorner.Name = "UICorner"
UICorner.Parent = _1
...
ImageLabel.BorderColor3 = Color3.new(0, 0, 0)
ImageLabel.Transparency = 1
ImageLabel.Image = "rbxassetid://16377232199"
...
local row = 0
function Gui_to_return.Window(conf)
local _return = setmetatable({}, Gui_to_return)
...
gui.Enabled = false
local ScreenGui: ScreenGui = create("ScreenGui", {Name = "ScreenGui"
IgnoreGuiInset = true
ResetOnSpawn = false
ZIndexBehavior = Enum.ZIndexBehavior.Sibling
Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")})
local Frame: Frame = create("Frame", {Name = "Frame"
Position = UDim2.new(0.5, 0, 0.5, 0)
...
AnchorPoint = Vector2.new(0.5, 0.5)
Parent = ScreenGui})
local UICorner: UICorner = create("UICorner", {Name = "UICorner"
CornerRadius = UDim.new(0, 12)
Parent = Frame})
local key: TextBox = create("TextBox", {Name = "key"
...
AnchorPoint = Vector2.new(0, 1)
Text = "Enter Key"
TextColor3 = Color3.new(0.996078, 0.996078, 0.996078)
TextSize = 14
FontFace = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
TextScaled = true
TextWrapped = true
...
Parent = Frame})
local https: TextBox = create("TextBox",{Name = "https"
...
AnchorPoint = Vector2.new(0.5, 0)
Text = https_
TextColor3 = Color3.new(0.52549, 0.52549, 1)
TextSize = 14
FontFace = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal)
TextScaled = true
TextWrapped = true
RichText = true
PlaceholderColor3 = Color3.new(0.52549, 0.52549, 1)
Parent = Frame
TextEditable=false
ClearTextOnFocus=false})
local Crown: ImageLabel = create("ImageLabel",{Name = "Crown"
...
if b == nil then
cont = false
local errorText = string.format("Not found %s in %s", i, v.id)
error(errorText)
end
end
if cont then
...
color_show:Fire(a)
if not f then
f = color.Event:Connect(function(colorColor)
new:WaitForChild("Image").ImageColor3 = colorColor
new:WaitForChild("Color").Text = "("..tostring(colorColor.R*255)..", "..tostring(colorColor.G*255)..", "..tostring(colorColor.B*255)..")"
v.Callback(colorColor)
end)
else
f:Disconnect()
end
...
ActivateButton.MouseButton1Down:Connect(OnActive3)
ActivateButton.TouchTap:Connect(OnActive3)
elseif v.id == "select" then-- {Text: string, Buttons: {{Text: string, Callback: (button: TextButton) -> ()}}}
local MousePosition = game:GetService("UserInputService"):GetMouseLocation()
new:WaitForChild("TextLabel").Text = v.Text
local LasestFrame = nil
local function onactive()
if LasestFrame then
LasestFrame:Destroy()
LasestFrame = nil
else
local FrameSelect = Instance.new("Frame", gui)
LasestFrame = FrameSelect
FrameSelect.Size = UDim2.new()
FrameSelect.Position = UDim2.new(0, MousePosition.X, 0, MousePosition.Y)
FrameSelect.BackgroundColor3 = Color3.fromRGB(33, 33, 33)
FrameSelect.BorderSizePixel = 0
local Uistroke = Instance.new("UIStroke", FrameSelect)
Uistroke.Color = Color3.fromRGB(20, 20, 20)
game:GetService("TweenService"):Create(FrameSelect, TweenInfo.new(0.5), {Size = UDim2.new(0, 125, 0, #v.Buttons*25)}):Play()
for index, button in v.Buttons do
local TextButton = Instance.new("TextButton", FrameSelect)
TextButton.Text = button.Text
TextButton.Size = UDim2.new(1, 0, 0, 25)
TextButton.TextColor3 = Color3.fromRGB(255, 255, 255)
TextButton.BackgroundColor3 = Color3.fromRGB(50, 50, 50)
TextButton.BorderSizePixel = 0
TextButton.Position = UDim2.new(0, 0, 0, (index-1)*25)
TextButton.MouseButton1Down:Connect(button.Callback)
TextButton.TouchTap:Connect(button.Callback)
end
end
end
new:WaitForChild("ActivateButton").MouseButton1Down:Connect(onactive)
new:WaitForChild("ActivateButton").TouchTap:Connect(onactive)
end
end
end
end
...
function _return2.Select(configurations2)
local Text = configurations2.Text or nil
local Buttons = configurations2.Buttons or nil
table.insert(sections, {id = "select", Text = Text, Buttons = Buttons})
end
return _return2
end
local templates = gui:WaitForChild("Templates")
