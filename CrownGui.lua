...
local function create_gui()
	...
	local ActivateButton2 = create("TextButton", {Name = "ActivateButton";Size = UDim2.new(1, 0, 1, 0);BackgroundColor3 = Color3.new(1, 1, 1);BackgroundTransparency = 1;BorderSizePixel = 0;BorderColor3 = Color3.new(0, 0, 0);Text = "";TextTransparency = 0;TextColor3 = Color3.new(1,1,1);TextSize = 16;FontFace = Font.new("rbxasset://fonts/families/SourceSansPro.json", Enum.FontWeight.Regular, Enum.FontStyle.Normal);AutoButtonColor = false;Parent = Slide, TextXAlignment = Enum.TextXAlignment.Left})
